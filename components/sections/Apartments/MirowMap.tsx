...
export const MirowMap = () => {
  const apiKey = process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY;
  const t = useTranslations("mirowMap");
    ...
    <section className="px-6 pb-16 md:px-10 lg:px-12">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
        <div className="md:col-span-4">
          ...
          <h2 className="font-display text-[32px] font-semibold leading-[1] tracking-tight text-skyline-ink md:text-[40px]">
            {t("titleLine1")}
            <br />
            {t("titleLine2")}
          </h2>
                ...
                <button
                  ...
                  className={`flex w-full items-center gap-4 rounded-lg border p-4 text-left transition ${
                    isActive
                      ...
                      : "border-skyline-line bg-white hover:border-skyline-blue/40 hover:bg-skyline-blue-soft/40"
                  }`}
                >
                  <span
        ...
        <div className="relative h-[360px] overflow-hidden rounded-xl border border-skyline-line bg-skyline-blue-soft md:col-span-8 md:h-[480px]">
          {apiKey ? (
